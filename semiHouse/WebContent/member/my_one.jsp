...
<script>
    $(function () {
		...
		var data=
        {
        	one_no:<%=oneDto.getOne_no()%>,
        	house_no:<%=oneDto.getHouse_no()%>,
        	member_no:<%=oneDto.getMember_no()%>, 
        	broker_no:<%=oneDto.getBroker_no()%>,
        	deposit : '<%=oneDto.getDeposit()%>',
        	monthly: '<%=oneDto.getMonthly()%>',
        	address: '<%=oneDto.getAddress()%>',
        	address2: '<%=oneDto.getAddress2()%>',
        	floor: '<%=oneDto.getFloor()%>',
        	loan: '<%=oneDto.getLoan()%>',
        	animal: '<%=oneDto.getAnimal()%>',
        	...
        	bill : '<%=oneDto.getBill()%>',
        	direction: '<%=oneDto.getDirection()%>',
        	title: '<%=oneDto.getTitle()%>'
        }
