...
<script>
    $(function () {
		...
		var data=
        {
        	villatwo_no:<%=villatwoDto.getVillatwo_no()%>,
        	house_no:<%=villatwoDto.getHouse_no()%>,
        	member_no:<%=villatwoDto.getMember_no()%>, 
        	broker_no:<%=villatwoDto.getBroker_no()%>,
        	deposit : '<%=villatwoDto.getDeposit()%>',
        	monthly: '<%=villatwoDto.getMonthly()%>',
        	address: '<%=villatwoDto.getAddress()%>',
        	address2: '<%=villatwoDto.getAddress2()%>',
        	floor: '<%=villatwoDto.getFloor()%>',
        	loan: '<%=villatwoDto.getLoan()%>',
        	animal: '<%=villatwoDto.getAnimal()%>',
        	...
        	direction: '<%=villatwoDto.getDirection()%>',
        	title: '<%=villatwoDto.getTitle()%>'
        }
