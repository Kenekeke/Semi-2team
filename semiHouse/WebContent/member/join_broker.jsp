	...
	<div id="wrap">
		<form class="formCheck" action = "join_broker.do" method="post">
			...
			<div>
				...
				<div class="join_row">
					<label for="broker_name">중개사무소 이름 </label>
					<input type="text" id="broker_name" name="broker_name" required class="input" placeholder="공인중개사 상호명을 입력해주세요">
				</div>
				<div class="join_row">
					<label for="broker_address">중개사무소 주소 </label>
					<input type="text" id="broker_address" name="broker_address" required class="input" placeholder="주소를 입력해주세요">
				</div>
				<div class="join_row">
					<label for="broker_address">나머지 주소 </label>
					<input type="text" id="broker_address2" name="broker_address2" required class="input" placeholder="나머지 주소를 입력해주세요">
				</div>
				<div class="join_row">
					<label for="broker_landline">중개사무소 번호 </label>
					<input type="text" id="broker_landline" name="broker_laneline" required class="input" placeholder="공인중개사 전화번호가 없을시 휴대폰번호를 다시 입력해주세요.">
				</div>
